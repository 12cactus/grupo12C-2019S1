...
class MovementTest: JavaSpec<MovementContextTest>() {
    override fun define(){
        describe("Dado un user sin movimientos"){
            context().guest(Supplier { User("Jhon Snow") })

            describe("El inviado realiza un bankDeposit de 100"){
                it("El user tiene un Movement del type BANKDEPOSIT de 100 en su cuenta"){
            ...
            describe("El inviado realiza un bankWithdrawal de 100"){
                it("El user tiene un Movement del type BANKWITHDRAWAL de 100 en su cuenta"){
            ...
            describe("El user realiza un bankDeposit de 500 y un bankWithdrawal de 150"){
                it("El user tiene 2 movimientos y el resumen da un cost de 350"){
